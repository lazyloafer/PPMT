...
def common_args():
    ...
    parser.add_argument("--train_file", type=str,
                        default="../Data/FB15k-237/train.json") # FB15k-237
    ...
    parser.add_argument("--do_test", default=True, help="for final test submission")
    parser.add_argument("--training_inference_schema", default="matching", type=str)  # classification matching

    # model
    parser.add_argument("--model_name",
                        default="bert-base-cased", type=str)  # bert-base-cased
    ...
    parser.add_argument("--nentity", default=14505, type=int)  # 63361  14505
    parser.add_argument("--nrelation", default=474, type=int)  # 400  474
    ...
    parser.add_argument("--is_memory", default=True, type=bool)
...
def train_args():
    parser = common_args()
    # optimization
    parser.add_argument('--prefix', type=str, default="FB15k-237_reasoning")
